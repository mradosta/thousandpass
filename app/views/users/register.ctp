	...
	<div class="right">
		...
		<div class="text_and_logo">
			...
			<?php
				...
				echo $form->input('lastname', array('label' => __('Lastname', true)));
				echo $form->input('birthdate', array('label' => __('Birth Date', true)));
				echo $form->input('sex', array('label' => __('Sex', true),
					'options' 	=> array(
						'm' => __('Male', true),
						'f' => __('Female', true))));
				echo $form->input('country', array('label' => __('Country', true),
					'options'	=> array(
						'North America' => array(
							'Anguilla' => 'Anguilla',
				...
				echo $form->input('password', array('label' => __('Password', true), 'type' => 'password', ));
				echo $form->input('repassword', array('label' => __('Retype Password', true), 'type' => 'password', ));
				echo $form->input('email', array('label' => __('Email', true)));

				echo $html->link(__('Read the contract', true), array('controller' => 'pages', 'action' => 'contract'), array('target' => '_BLANK'));
...
HE LEÍDO, ENTENDIDO Y ESTOY DE ACUERDO';
	...
	//echo $form->input('policy', array('value' => $policy, 'type' => 'textbox', 'disabled' => true));
